...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        type.Url = BaseUrl + "userfiles/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "userfiles/";
        type.MaxSize = 0;
        ...
        type.Url = BaseUrl + "userimages/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "userimages/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("Flash");
        type.Url = BaseUrl + "userflash/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "userflash/";
        type.MaxSize = 0;
